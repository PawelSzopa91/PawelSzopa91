...
| :--- | :--- | :--- |
| **[E-Commerence Shop- data from Kaggle - Olist SQL Analysis](https://github.com/PawelSzopa91/olist-sql-analysis)** | End-to-end logistics & revenue audit for Brazilian e-commerce. | `SQL` `PostgreSQL` |
